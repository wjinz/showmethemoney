    ...
    <div style={{
      ...
      <Card style={{ width: "100%", maxWidth: 400, padding: 24, position: "relative" }}>
        <button onClick={onClose} style={{
          ...
          border: "none", fontSize: 20, color: "var(--text-faint)", cursor: "pointer"
        }}>✕</button>
        ...
        <textarea 
          ...
          style={{
            width: "100%", height: 120, background: "#F3F4F6", border: "1px solid var(--border)",
        ...
        <button 
          ...
          style={{
            ...
            background: isSubmitting ? "var(--surface-alt)" : "#3B82F6",
