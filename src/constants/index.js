...
export const DEFAULT_WIDGET_LAYOUT = {
  mobile: [
    { i: 'sos_status',       x: 0, y: 0,  w: 1, h: 3 },
    { i: 'today_status',     x: 0, y: 3,  w: 1, h: 3 },
    { i: 'allowance_insight', x: 0, y: 6,  w: 1, h: 4 },
    { i: 'spending_insight', x: 0, y: 10, w: 1, h: 3 },
    { i: 'budget_ring',      x: 0, y: 13, w: 1, h: 4 },
    { i: 'goal',             x: 0, y: 17, w: 1, h: 3 },
    { i: 'tax_guide',        x: 0, y: 20, w: 1, h: 3 },
    { i: 'ai_nudge',         x: 0, y: 23, w: 1, h: 2 },
  ],
  desktop: [
    { i: 'sos_status',       x: 0, y: 0, w: 2, h: 3 },
    { i: 'today_status',     x: 0, y: 3, w: 1, h: 3 },
    { i: 'spending_insight', x: 1, y: 3, w: 1, h: 3 },
    { i: 'allowance_insight', x: 0, y: 6, w: 2, h: 4 },
    { i: 'budget_ring',      x: 0, y: 10, w: 1, h: 4 },
    { i: 'goal',             x: 1, y: 10, w: 1, h: 3 },
    { i: 'tax_guide',        x: 0, y: 14, w: 1, h: 3 },
    { i: 'ai_nudge',         x: 1, y: 13, w: 1, h: 2 },
  ],
};
